...
![Equity Curve vs Buy & Hold](wave_BTCUSDT_20260507T071559_equity.png)
...
| Calmar Ratio | $\text{CAGR}\,/\,|\text{MDD}|$ | 0.0000 |
...
![Wave Regime Timeline](wave_BTCUSDT_20260507T071559_wave_timeline.png)
...
![Regime Hit Rate vs Horizon](wave_BTCUSDT_20260507T071559_wave_hit_rate.png)
...
![Per-Regime Mean Forward Return vs Horizon](wave_BTCUSDT_20260507T071559_wave_fwd_return.png)
...
![Regime Transition Matrix](wave_BTCUSDT_20260507T071559_wave_transition.png)
...
![Regime × Tide Bias Confusion](wave_BTCUSDT_20260507T071559_wave_confusion.png)
...
| **Calmar** | $\frac{\text{CAGR}}{|\text{MDD}|}$ | Return per unit of worst drawdown |

### Wave Regime Accuracy

| Metric | Formula | Plain language |
|---|---|---|
| **Regime Hit Rate** | $\frac{|\{t \in \mathcal{D} : g(\rho_t) \cdot f_t^{(h)} > 0\}|}{|\mathcal{D}|} \times 100$ | % of BREAKOUT/BREAKDOWN bars where forward return aligned with regime direction |
