...
![Equity curve](tide_BTCUSDT_btcbase_4h_v2_equity.png)

### Drawdown

![Drawdown](tide_BTCUSDT_btcbase_4h_v2_drawdown.png)

### Regime overlay

![Regime overlay](tide_BTCUSDT_btcbase_4h_v2_regime.png)

### Signal timeline

![Signal timeline](tide_BTCUSDT_btcbase_4h_v2_accuracy_timeline.png)

### Hit rate vs horizon

![Hit rate vs horizon](tide_BTCUSDT_btcbase_4h_v2_accuracy_hitrate.png)

### Forward return by bias

![Forward return by bias](tide_BTCUSDT_btcbase_4h_v2_accuracy_fwdret.png)

### Regime-bias confusion

![Regime-bias confusion](tide_BTCUSDT_btcbase_4h_v2_accuracy_confusion.png)

### PnL proxy vs horizon

![PnL proxy vs horizon](tide_BTCUSDT_btcbase_4h_v2_accuracy_pnl.png)
