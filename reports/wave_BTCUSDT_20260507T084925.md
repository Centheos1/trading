...
**Symbol:** BTCUSDT | **Timeframe:** 5m | **Mode:** ISOLATED | **Exchange:** binance  
**Period:** 2022-12-31 05:40:00 → 2024-08-13 21:40:00 | **Bars:** 170,401

## Equity Curve

![Equity Curve vs Buy & Hold](wave_BTCUSDT_20260507T084925_equity.png)

## Returns & Growth
| Metric | Formula | Value |
|---|---|---|
| Total Return | $\frac{E_N - E_0}{E_0}$ | -3218.30% |
| CAGR | $(E_N/E_0)^{P/N} - 1$ | 0.00% |
| Initial Capital | $E_0$ | $10,000.00 |
| Final Equity | $E_N$ | $-311,830.07 |

## Risk
| Metric | Formula | Value |
|---|---|---|
| Ann. Volatility | $\sigma(r) \times \sqrt{P}$ | 107.76% |
| Ann. Downside Vol | $\sigma(\min(r,0)) \times \sqrt{P}$ | 82.28% |
| Max Drawdown | $\min_t (E_t - \text{peak}_t)/\text{peak}_t$ | -3223.57% |
| Max DD Duration (bars) | 170,400 |
| VaR 95% | $-Q_{0.05}(r)$ | 0.46% |
| CVaR 95% (ES) | $-\mathbb{E}[r \mid r < \text{VaR}_{95}]$ | 0.86% |
| VaR 99% | $-Q_{0.01}(r)$ | 1.07% |
| CVaR 99% (ES) | $-\mathbb{E}[r \mid r < \text{VaR}_{99}]$ | 1.65% |
| Ulcer Index | $\sqrt{N^{-1}\sum D_t^2}$ | 15.4739 |
| Skewness | $\frac{1}{N}\sum((r_t-\bar r)/\sigma)^3$ | -1.3584 |
| Excess Kurtosis | $\frac{1}{N}\sum((r_t-\bar r)/\sigma)^4 - 3$ | 114.3039 |

## Risk-Adjusted
| Metric | Formula | Value |
|---|---|---|
| Sharpe Ratio | $(\bar{r} \cdot P - R_f)\,/\,(\sigma\sqrt{P})$ | -18.4240 |
| Sortino Ratio | $(\text{CAGR} - \text{MAR})\,/\,(\sigma_d\sqrt{P})$ | -24.1300 |
...
| Exposure % | 84.0% |
| Win Rate | 41.45% |
| Profit Factor | 0.4358 |
| Avg Win | $27.72 |
| Avg Loss | $-45.03 |
| Expectancy / Bar | -0.0189% |

## Per-Regime Breakdown
| Regime | Time % | PnL Contribution | Sharpe | N Bars |
|---|---|---|---|---|
| BREAKOUT | 2.3% | $-11,532.12 | -8.99 | 3,899 |
| MEAN_REVERSION | 81.7% | $-295,499.99 | -21.43 | 139,164 |
| BREAKDOWN | 3.5% | $-264.61 | -20.69 | 5,940 |
| NEUTRAL | 12.6% | $-14,533.34 | -78.09 | 21,398 |

## Monthly Returns
Best month: 146.95%  |  Worst month: -480.17%  |  Positive months: 90.0%
...
![Wave Regime Timeline](wave_BTCUSDT_20260507T084925_wave_timeline.png)
...
![Regime Hit Rate vs Horizon](wave_BTCUSDT_20260507T084925_wave_hit_rate.png)
...
![Per-Regime Mean Forward Return vs Horizon](wave_BTCUSDT_20260507T084925_wave_fwd_return.png)
...
![Regime Transition Matrix](wave_BTCUSDT_20260507T084925_wave_transition.png)
...
![Regime × Tide Bias Confusion](wave_BTCUSDT_20260507T084925_wave_confusion.png)
